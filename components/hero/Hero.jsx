...
export default function Hero() {
  return (
    <section className="px-2 flex justify-center">
      <div className="relative bg-[#0066ff] w-full max-w-[1920px] lg:min-h-[800px] min-h-[600px] overflow-hidden md:rounded-[80px] rounded-[30px]">
        ...
        {/* Glavni sadržaj */}
        <div className="relative max-w-[1300px] mx-auto px-6 lg:py-40 py-28 lg:items-center text-white z-10">
          <Reveal>
